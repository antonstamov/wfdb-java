...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /home/ikaro/workspace/wfdb-java/nativelibs/linuxi386//database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /home/ikaro/workspace/wfdb-java/nativelibs/linuxi386//database).
...
# define DEFWFDB	". /home/ikaro/workspace/wfdb-java/nativelibs/linuxi386//database"
#else
# define DEFWFDB ". /home/ikaro/workspace/wfdb-java/nativelibs/linuxi386//database http://physionet.org/physiobank/database"
#endif
