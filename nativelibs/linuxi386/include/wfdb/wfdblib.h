...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /home/ikaro/workspace/wfdb-java/nativelibs/linuxi386/tmp/wfdb-10.5.13/build/database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /home/ikaro/workspace/wfdb-java/nativelibs/linuxi386/tmp/wfdb-10.5.13/build/database).
...
# define DEFWFDB	". /home/ikaro/workspace/wfdb-java/nativelibs/linuxi386/tmp/wfdb-10.5.13/build/database"
#else
# define DEFWFDB ". /home/ikaro/workspace/wfdb-java/nativelibs/linuxi386/tmp/wfdb-10.5.13/build/database http://physionet.org/physiobank/database"
#endif
