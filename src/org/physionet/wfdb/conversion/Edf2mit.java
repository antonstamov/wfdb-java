 ...
 * 
 */
public class Edf2mit extends Wfdbexec {

	private static final String TAG = "edf2mit";
	public static final String URL="http://www.physionet.org/physiotools/wag/edf2mi-1.htm";
	
	public static enum Arguments {
		//Define input arguments syntax is:
		// argumentName(number of parameters,is optional,WDFD command string)
		edfFileName(1,false, "-i"),
		isBigEndian(0,true, "-b"),
