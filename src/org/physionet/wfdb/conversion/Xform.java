 ...
 * 
 */
public class Xform extends Wfdbexec {

	private static final String TAG = "xform";
	public static final String URL="http://www.physionet.org/physiotools/wag/xform-1.htm";

	public static enum Arguments {
		//Define input arguments syntax is:
		// argumentName(number of parameters,is optional,WDFD command string)
		inputRecord(1,false, "-i"),
		annotator(1, true, "-a"),
		clipOutput(0,true, "-c"),
		dither(0,true, "-d"),
		startTime(1, true, "-f"),
		highResolution(0, true,"-H"),
		multifrequencyMode(0,true,"-M"),
		outputRecordName(1, true, "-n"),
		outputRecordNameWithDescfromHeaderFile(1, true, "-N"),
		outputRecordNamefromExistingHeaderFile(1,true, "-o"),
		singalList(1,true, "-s"),
		script(1,true, "-S"),
		stopTime(1,true, "-t"),
		uniqueAnnotations(0,true, "-u");
