 ...
 * 
 */
public class Gqpost extends Wfdbexec {

	private static final String TAG = "gqpost";
	public static final String URL="http://www.physionet.org/physiotools/wag/gqrs-1.htm";
	
	public static enum Arguments {
		//Define input arguments syntax is:
		// argumentName(number of parameters,is optional,WDFD command string)
		recordName(1,false, "-i"),
		annotator(1,true, "-a"),
		configurationFile(1,true, "-c"),
		startTime(1,false, "-f"),
		highResolution(0,false, "-H"),
		threshold(1,false, "-m"),
		outputAnnotationName(1,false, "-o"),
		stopTime(1,false, "-t");
