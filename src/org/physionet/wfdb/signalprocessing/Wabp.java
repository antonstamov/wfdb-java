 ...
 * 
 */
public class Wabp extends Wfdbexec {

	private static final String TAG = "wabp";
	public static final String URL="http://www.physionet.org/physiotools/wag/wabp-1.htm";
	
	public static enum Arguments {
		//Define input arguments syntax is:
		// argumentName(number of parameters,is optional,WDFD command string)
		recordName(1,true, "-r"),
		dumpRawAndPreprocessedSamples(0,true, "-d"),
		startTime(1,true, "-f"),
		stopTime(1,true, "-t"),
		highResolution(0,true, "-H"),
		resampleAt125Hz(0,true, "-R"),
		signal(1,true, "-s"),
		verbose(1,false, "-v");
