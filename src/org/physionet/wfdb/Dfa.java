 ...
 * 
 */
public class Dfa extends Wfdbexec {

	private static final String TAG = "dfa";
	public static final String URL="http://www.physionet.org/physiotools/wag/dfa-1.htm";

	public static enum Arguments {
		//Define input arguments syntax is:
		// argumentName(number of parameters,is optional,WDFD command string)
		polynomialDegree(1,true, "-k"),
		doNotIntegrate(0, true, "-i"),
		setSmallestBoxWidth(1,true, "-l"),
		useSlidingWindow(0,true, "-s"),
		setLargestBoxWidth(1,true, "-u");
