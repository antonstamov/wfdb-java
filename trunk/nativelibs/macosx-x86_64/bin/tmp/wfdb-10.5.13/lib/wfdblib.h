...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /Users/admin/Documents/workspace/wfdb-java/nativelibs/macosx-x86_64/bin//database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /Users/admin/Documents/workspace/wfdb-java/nativelibs/macosx-x86_64/bin//database).
...
# define DEFWFDB	". /Users/admin/Documents/workspace/wfdb-java/nativelibs/macosx-x86_64/bin//database"
#else
# define DEFWFDB ". /Users/admin/Documents/workspace/wfdb-java/nativelibs/macosx-x86_64/bin//database http://physionet.org/physiobank/database"
#endif
