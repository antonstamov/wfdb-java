 ...
 * 
 */
public class Ad2m extends Wfdbexec {

	private static final String TAG = "ad2m";
	public static final String URL="http://www.physionet.org/physiotools/wag/a2m-1.htm";
	
	public static enum Arguments {
		//Define input arguments syntax is:
		// argumentName(number of parameters,is optional,WDFD command string)
		convertAHADbCompressed(0, true, "-c"),
		startTime(1, true, "-f"),
		stopTime(1, true, "-t");
