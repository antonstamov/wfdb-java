 ...
 * 
 */
public class Edr extends Wfdbexec {

	private static final String TAG = "edr";
	public static final String URL="http://www.physionet.org/physiotools/wag/edr-1.htm";
	...
	public static enum Arguments {
		...
		annotatorName(1,false, "-i"),
		edrWindow(1,true, "-d"),
		startTime(1,true, "-f"),
		stopTime(1,true, "-t"),
		ouputAnnotator(1,true, "-o"),
		signalList(1,true, "-s"),
		verbose(0,true, "-v");
