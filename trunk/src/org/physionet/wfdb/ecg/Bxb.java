 ...
 * 
 */
public class Bxb extends Wfdbexec {

	private static final String TAG = "bxb";
	public static final String URL="http://www.physionet.org/physiotools/wag/bxb-1.htm";
	...
	public static enum Arguments {
		...
		condensedReports(0,false, "-c"),
		reportStatistics(0,false, "-C"),
		startTime(1,false, "-f"),
		appendLineFormat(1,false, "-l"),
		appendLineFormatandStatistics(1,false, "-L"),
		outputAnnotationFileName(0,false, "-o"),
		expandedoutputAnnotationFileName(0,false, "-O"),
		appendStandardReportstoFile(1,false, "-s"),
		appendStandardReportsandStatstoFile(1,false, "-S"),
		stopTime(1,false, "-t"),
		verbose(0,false, "-v"),
		matchWindow(1,false, "-w");
