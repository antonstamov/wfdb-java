 ...
 * 
 */
public class Ihr extends Wfdbexec {

	private static final String TAG = "ihr";
	public static final String URL="http://www.physionet.org/physiotools/wag/ihr-1.htm";
	...
	public static enum Arguments {
		...
		tolerance(1,true, "-d"),
		startTime(1,true, "-f"),
		includeQRSAnnotationIntervals(0,true, "-i"),
		includeAnnotaionTypeInterval(1,true, "-p"),
		stopTime(1,true, "-t"),
		printOutputSampleNumber(0,true, "-v"),
		excludeIntervalsFollowingReject(0,true, "-x"),
		outputFile(1,true, "-o");
