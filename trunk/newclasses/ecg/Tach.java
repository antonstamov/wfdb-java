 ...
 * 
 */
public class Tach extends Wfdbexec {

	private static final String TAG = "tach";
	public static final String URL="http://www.physionet.org/physiotools/wag/tach-1.htm";
	...
	public static enum Arguments {
		...
		disableOutlierRejection(0,true, "-O"),
		setSmoothingConstant(1,true, "-s"),
		printOuputSampleNumber(0,true, "-v"),
		stopTime(1,true, "-t");
